...
//  Mapping
//
//  Created by Findlay Wood on 04/04/2018.
...
class ThirdViewController: UIViewController {
    ...
    @IBAction func summary(_ sender: UIBarButtonItem){
    ...
    override func viewDidLoad() {
        ...
        //navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Summary", style: .plain, target: self, action: #selector(summary(_:)))
...
extension ThirdViewController: IAxisValueFormatter{
...
extension ThirdViewController: ChartViewDelegate{
